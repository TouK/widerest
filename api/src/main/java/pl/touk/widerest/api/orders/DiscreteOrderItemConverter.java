                ...
                .attributes(
                        Optional.ofNullable(discreteOrderItem.getOrderItemAttributes())
                                ...
                                .map(stream -> stream.collect(toMap(
                                        ...
                                        orderItemAttribute -> Try.of(() -> objectMapper.readValue(orderItemAttribute.getValue(), Object.class)).getOrElse(Optional.ofNullable(orderItemAttribute.getValue()).orElse(""))
                                ))).orElse(null)
                )
                .build();
