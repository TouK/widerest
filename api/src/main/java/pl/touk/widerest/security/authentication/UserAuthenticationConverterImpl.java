...
public class UserAuthenticationConverterImpl implements UserAuthenticationConverter {
    ...
    public Map<String, ?> convertUserAuthentication(Authentication authentication) {
        ...
        if (principal instanceof AdminUserDetails) {
            response.put("iss", "widerest/backoffice");
            response.put("sub", ((AdminUserDetails) principal).getId());
        } else if (principal instanceof CustomerUserDetails){
            response.put("iss", "widerest/site");
            response.put("sub", ((CustomerUserDetails) principal).getId());
        }
